...
import net.sf.delineate.utility.ImageUtilities;
...
//        XPathTool xpathTool = new XPathTool(new File(parameterFile));
                                                  XPathTool xpathTool = new XPathTool(parameterFile);
...
//    }
    ...
    private void setConvertImageActionEnabled(boolean enabled) {
        for (JPanel aConvertPanelList : convertPanelList) {
            JPanel panel = aConvertPanelList;
    ...
    public static void main(String args[]) throws Exception {
      String serializable = args.length > 0 ? args[0] : ClassLoader.getSystemResource("settings/parameters-autotrace.xml").toExternalForm();
      System.err.println("arg0:"+serializable);
      String potraceParameterFile = args.length > 1 ? args[1] : ClassLoader.getSystemResource("settings/parameters-potrace.xml").toExternalForm();
      System.err.println("arg1:"+potraceParameterFile);
      new DelineateApplication(serializable,
          potraceParameterFile);
    }
